...
<?php $__env->startPush('css'); ?>
   ...
   <link rel="stylesheet" href="<?php echo e(asset('css/inputPost.css')); ?>"> <!-- Post Now hold by inputPost.css -->
   <link rel="stylesheet" href="<?php echo e(asset('css/post.css')); ?>">      <!-- POST hold by post.css -->
   <!-- Font Awesome -->
...
<body onload="pointInfo();">
         ...
         <div id="help">
            <div class="popup">
               ...
               <p>Points can be used to <a href="<?php echo e(url('showRewards')); ?>"><strong>redeem rewards</strong></a> in our website.</p>
...
<!---------------------------------------------------------- Input post ---------------------------------------------------------->
         ...
         <input type="hidden" id="userLimit" value="<?php echo e($user->dailyLimit); ?>">
         <input type="hidden" id="limitNotify" value="1">
         <input type="hidden" id="userPoints" value="<?php echo e($user->points); ?>">
            <!-- begin tab-content -->
                  ...
                  <ul class="timeline" id="post-data1">
                     ...
                     <li id="post-data">
                        ...
                        <div class="timeline-time">
                           ...
                           <span class="time"><?php echo e(\Carbon\Carbon::now()->addHours(8)->format('H:i')); ?></span>
                        </div>
                        <!-- end timeline-time -->
                        <!-- begin timeline-icon -->
                        ...
                        <div class="timeline-body">
                           <div class="row input-post">
                              ...
                              <div class="col-md-2 col-sm-3 rounded-image">
                                 ...
                                 <img class="userAvatar" src="<?php echo e(asset('images/user/'.$user->userAvatar)); ?>" alt="userAvatar">
                              </div>
                              <!-- Post Input Area -->
                              <div class="col-md-10 col-sm-9">
                                 <section class="panel  timeline-post-to">
                                    <div class="panel-body">
                                          <form role="form" action="<?php echo e(route('addPost')); ?>" method="POST" enctype="multipart/form-data">
                                             <?php echo csrf_field(); ?>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-2 col-sm-2 text-right">
                                                      <button type="submit" class="btn btn-primary btn-color" style='color:#2d353c;' id="postbtn" data-id="<?php echo e($user->id); ?>">Post</button>
                                                </div>
                                             </div>
                                          </form>
                                    </div>
...
<!------------------------------------------------------------ POST loading ------------------------------------------------------------>
                     <li id="ajaxloader"><!-- POST loading -->
                        ...
                        <div class="timeline-body ajax-loader ajax-load" style="color:whitesmoke;display:;" >
                           <img src="<?php echo e(asset('images/loader.gif')); ?>" height="40px" alt="loader" style="float:left;margin-top:-10px;margin-right:5px;"> <span id="loader-text">Loading...</span>
                        </div>
                        <!-- begin timeline-body -->
                     </li>
                  </ul>
      ...
      if(dailyLimit< 15){
         ...
         if(btn.style.color == "rgb(2, 235, 13)" && document.getElementById(earnid).value =="1"){
            ...
            Swal.fire({
               ...
               heightAuto: false,
               // timer: '2000',
               footer: '<a href="<?php echo e(url('showRewards')); ?>">Redeem reward?</a>',
            })
...
<div class="modal top fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-mdb-backdrop="static" data-mdb-keyboard="true">
  <div class="modal-dialog   modal-dialog-centered">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo e(route('editPost')); ?>" method="POST" enctype="multipart/form-data">
         <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Project\resources\views/community.blade.php ENDPATH**/ ?>