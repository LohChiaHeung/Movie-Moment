    ...
    <div class="row">
        ...
        <?php if(Session::has('success')): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Dear <?php echo e(Auth::user()->name); ?>,</strong> <?php echo e(Session::get('success')); ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-4 offset-md-8">  
            <a class="admin-btn" href="<?php echo e(route('admin.rewardList')); ?>">Rewards list</a>
        </div>
        <div class="col-md-8 offset-md-2">
        <form action="<?php echo e(route('admin.addReward')); ?>" method="POST" enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Project\resources\views/backend/addReward.blade.php ENDPATH**/ ?>