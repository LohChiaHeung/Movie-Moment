    ...
    <ul class="nav-list">
     ...
     <li class="profile">
         <div class="profile-details">
          <img src="/images/user/<?php echo e(Auth::user()->userAvatar); ?>">
           <div class="name_job">
             <div class="name"><?php echo e(Auth::user()->name); ?></div>
           </div>
         </div>
         <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <?php echo e(__('Sign out')); ?>
...
<?php /**PATH C:\Users\User\Project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>