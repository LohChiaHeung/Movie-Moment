...
<html lang="en">
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                           ...
                           <li class="nav-item">
                           <a class="nav-link <?php echo e(Route::currentRouteNamed('top10') ? 'active' : ''); ?>" href="<?php echo e(url('top10')); ?>"><i class="fas fa-crown"></i> Top 10 Movie (Daily)  </a>         
                           </li>
                           <li class="nav-item">
                              <a class="nav-link dropdown-toggle" href="#" ></i>Others</a>
                                 <ul class="dropdown-menu">
                                 <li><a class="dropdown-item" href="<?php echo e(url('showProjectMembers')); ?>">Project Members</a></li>
                                 <li><a class="dropdown-item" href="<?php echo e(url('contact')); ?>">User Guide // Help</a></li>
                                 <li><a class="dropdown-item <?php echo e(Route::currentRouteNamed('showRewards') ? 'active' : ''); ?> <?php echo e(Route::currentRouteNamed('searchRewards') ? 'active' : ''); ?>" href="<?php echo e(url('showRewards')); ?>">Vouchers Redeem</a></li>
                                 <li><a class="dropdown-item" href="<?php echo e(url('contact')); ?>">Contact Us</a></li>
                                 <li><a class="dropdown-item" href="<?php echo e(url('showMembers')); ?>">Show Members(Admin)</a></li>
                                 <li><a class="dropdown-item" href="<?php echo e(url('addMembers')); ?>">Add Members(Admin)</a></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
 ...
 <div class="d-flex align-items-center ">
            <?php if(auth()->guard()->guest()): ?>
               <a href="<?php echo e(url('login')); ?>" class="m-r-15 text-inverse-lighter"><i class="fas fa-user"></i></a>
            <?php else: ?>
               <!-- Login Avatar -->
...
</html><?php /**PATH C:\Users\User\Project\resources\views//layout.blade.php ENDPATH**/ ?>